...
FragmentViewCreatedListener {
    ...
    public static class SettingsFragment extends PreferenceFragment {
        ...
        private ListPreference mIpMode;
        private ListPreference mCapInterface;
        ...
        private void setupExporterPrefs() {
            ...
            mRemoteCollectorIp.setOnPreferenceChangeListener(new EditTextPreference.OnPreferenceChangeListener(){
        ...
        private void setupTrafficInspectionPrefs() {
            ...
            mMitmWizard.setEnabled(mTlsDecryption.isChecked());
            mMitmWizard.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
        ...
        private void socks5ProxyHideShow(boolean tlsDecryption, boolean rootEnabled) {
            mSocks5Settings.setEnabled(!tlsDecryption && !rootEnabled);
        }
        ...
        private void rootCaptureHideShow(boolean enabled) {
            if (enabled) {
                ...
                mAutoBlockPrivateDNS.setEnabled(true);
                mBlockQuic.setEnabled(true);
                socks5ProxyHideShow(mTlsDecryption.isChecked(), false);
            }

            if (VpnReconnectService.isAvailable())
                mRestartOnDisconnect.setEnabled(!enabled);

        ...
        if(id == R.id.paid_features) {
            ...
            new AlertDialog.Builder(this)
                ...
                .setNeutralButton(R.string.copy_to_clipboard, new DialogInterface.OnClickListener(){
                    ...
                    @Override
                    public void onClick(DialogInterface p1, int p2) {
                            Utils.copyToClipboard(AboutActivity.this, deviceInfoStr);}}).show();
            return true;
            }
...
*/
    ...
    private void showLicenseDialog() {
        ...
        final String instId = billing.getInstallationId();
        ...
        if(Utils.isTv(this) && !billing.isPurchased(Billing.SUPPORTER_SKU)) {
            instIdText.setOnClickListener(new TextView.OnClickListener(){

                    @Override
                    public void onClick(View p1) {
                    
                    Utils.shareText(AboutActivity. this, getString(R.string.installation_id), instId);}});
            showQrCode(content, instId);
        }

        final TextView validationRc = content.findViewById(R.id.validation_rc);
        final EditText licenseCode = content.findViewById(R.id.license_code);
        licenseCode.setText(billing.getLicense());
        Utils.setTextUrls((TextView)(content.findViewById(R.id.paid_features_msg)), R.string.access_paid_features_msg, MainActivity.PAID_FEATURES_URL);

        content.findViewById(R.id.copy_id).setOnClickListener(new View.OnClickListener(){

                @Override
                public void onClick(View p1) {
                
                Utils.copyToClipboard(AboutActivity. this, instId);}});
        ...
        mLicenseDialog = new AlertDialog.Builder(this)
            ...
            .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener(){
                ...
                public void onClick(DialogInterface p1, int p2) {
                    ...
                    if(!was_valid && billing.isPurchased(Billing.SUPPORTER_SKU))
                        Utils.showToastLong(AboutActivity. this, R.string.paid_features_unlocked);
                }})
            ...
            .setNeutralButton(R.string.validate, new DialogInterface.OnClickListener(){
        ...
        mLicenseDialog.show();
        mLicenseDialog.getButton(AlertDialog.BUTTON_NEUTRAL).setOnClickListener(new View.OnClickListener(){
            ...
            validationRc.setTextColor(getColor(valid ? R.color.ok : R.color.danger));
        }});
        mLicenseDialog.getWindow().setLayout(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
    }

    private void showQrCode(final View dialog, final String instId) {
        ...
        // start activation
        mQrReqExecutor.execute(new Runnable(){
...
*/
                        ...
                        handler.post(new Runnable(){
                                @Override
                                public void run() {
                             onQrLicenseReceived(dialog, license);}});
                    }
                } finally {
                    con.disconnect();
                }
...
/*
    ...
    private void updateQrProgress(final View dialog) {

...
public class DnsSettings extends SettingsSubFragment {
    ...
    public void onCreatePreferences(@Nullable Bundle savedInstanceState, @Nullable String rootKey) {
      //  setPreferencesFromResource(R.xml.dns_preferences, rootKey);
        ...
        p1.setOnPreferenceChangeListener(new EditTextPreference.OnPreferenceChangeListener(){

                @Override
                public boolean onPreferenceChange(Preference p1, Object newValue) {
                 
                
                    Utils.validateIpv4Address(newValue.toString());return false;
                }});

        EditTextPreference p2 = Objects.requireNonNull(findPreference(Prefs.PREF_DNS_SERVER_V6));
        p2.setOnPreferenceChangeListener(new EditTextPreference.OnPreferenceChangeListener(){

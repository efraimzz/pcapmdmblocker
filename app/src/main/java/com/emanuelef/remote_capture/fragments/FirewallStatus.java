...
public class FirewallStatus extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mGrayColor = ctx.getColor( R.color.lightGray);

        view.findViewById(R.id.show_connections).setOnClickListener(new View.OnClickListener() {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        getActivity().getMenuInflater().inflate(R.menu.firewall_menu, menu);
        mMenu = menu;

        mToggle = (Switch) menu.findItem(R.id.toggle_btn).getActionView();
        mToggle.setOnCheckedChangeListener(new Switch.OnCheckedChangeListener() {

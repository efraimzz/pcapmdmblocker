...
public class PortMapFragment extends Fragment {
    ...
    public void openAddDialog() {
        ...
        final View view = inflater.inflate(R.layout.add_port_mapping_dialog, null);
        ...
        ((TextView) view.findViewById(R.id.redirect_ip)).setText("127.0.0.1");

        final AlertDialog dialog = new AlertDialog.Builder(ctx)
                .setView(view)
                .setTitle(R.string.port_mapping)
            .setPositiveButton(R.string.add_action, new DialogInterface.OnClickListener() {
    ...
    private PortMap validateAddDialog(View view) {
        EditText origPortField = (EditText) view.findViewById(R.id.orig_port);
        EditText redirectIpField = (EditText) view.findViewById(R.id.redirect_ip);
        EditText redirectPortField = (EditText) view.findViewById(R.id.redirect_port);

...
*/
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter = new ListEditAdapter(getContext());
...
*/
    ...
    private void showAddIpRule() {
        RuleAddDialog.showText(requireContext(), R.string.ip_address_or_cidr, new RuleAddDialog.RuleAddListener() {

                @Override
                public boolean addRule(String value, TextView field) {
    ...
    private void showAddProtoRule() {
        RuleAddDialog.showCombo(requireContext(), R.string.protocol, Utils.getL7Protocols(), new RuleAddDialog.RuleAddListener() {
    ...
    private void showAddCountryRule() {
        ...
        RuleAddDialog.showCombo(requireContext(), R.string.country, countryNames, new RuleAddDialog.RuleAddListener() {
...
/*
    ...
    private void showAddHostRule() {
        RuleAddDialog.showText(requireContext(), R.string.host, new RuleAddDialog.RuleAddListener(){
    ...
    private void showAddAppRule() {
        mAppSelDialog = new AppSelectDialog( requireActivity(), R.string.app,
...
/*
    ...
    private void confirmLoadManyRules(final String data) {
        Context context = requireContext();
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle(R.string.warning);
        builder.setMessage(R.string.many_rules_warning);
        builder.setCancelable(true);
        builder.setPositiveButton(R.string.import_action, new DialogInterface.OnClickListener(){
    ...
    private void confirmImport(final MatchList rules) {
        Context context = requireContext();
        AlertDialog.Builder builder = new AlertDialog.Builder(context);
        builder.setTitle(R.string.import_action);
        builder.setMessage(R.string.rules_merge_msg);
        builder.setCancelable(true);
        builder.setPositiveButton(R.string.keep_action, new DialogInterface.OnClickListener(){

                                      @Override
                                      public void onClick(DialogInterface p1, int p2) {
                                      importRules(rules);}});
        builder.setNegativeButton(R.string.discard_action, new DialogInterface.OnClickListener(){

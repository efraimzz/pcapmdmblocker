...
/*
        ...
        if(mConn != null) {
            ...
            if (protoMsg != null) {
                ...
                protoInfo.setOnClickListener(new View.OnClickListener(){
...
/*
    ...
    public void connectionUpdated() {
        ...
        if (mConn.error > 0) {
            ...
            if (errnoInfo != null) {
                ...
                mSocketErrnoInfo.setOnClickListener(new View.OnClickListener() {
        ...
        if(mConn.decryption_error != null) {
            mError.setTextColor(context.getColor(R.color.danger));
            mError.setText(mConn.decryption_error);
            mError.setVisibility(View.VISIBLE);
        } else if(mConn.is_blocked) {
            mError.setTextColor(context.getColor( R.color.warning));
            ...
            mError.setTextColor(context.getColor( R.color.colorTabText));
    ...
    private Pair<Integer, Integer> getSocketErrnoInfo(int errno) {
         switch (errno) {
            case 32 :/* EPIPE */
                return new Pair<>(R.string.errno_epipe, R.string.errno_epipe_msg);
            case 100 :/* ENETDOWN */
                return new Pair<>(R.string.errno_enetdown, R.string.errno_enetdown_msg);
            case 101 : /* ENETUNREACH */
                 return  new Pair<>(R.string.errno_enetunreach, R.string.errno_enetunreach_msg);
            case 102 : /* ENETRESET */
                  return  new Pair<>(R.string.errno_enetreset, R.string.errno_enetreset_msg);
            case 103 : /* ECONNABORTED */
                   return new Pair<>(R.string.errno_econnaborted, R.string.errno_econnaborted_msg);
            case 104 :/* ECONNRESET */
                   return new Pair<>(R.string.errno_econnreset, R.string.errno_econnreset_msg);
            case 110 :/* ETIMEDOUT */
                   return new Pair<>(R.string.errno_etimedout, R.string.errno_etimedout_msg);
            case 111 : /* ECONNREFUSED */
                 return  new Pair<>(R.string.errno_econnrefused, R.string.errno_econnrefused_msg);
            case 113 : /* EHOSTUNREACH */
                 return  new Pair<>(R.string.errno_ehostunreach, R.string.errno_ehostunreach_msg);
            default : return null;
        }
    }
}

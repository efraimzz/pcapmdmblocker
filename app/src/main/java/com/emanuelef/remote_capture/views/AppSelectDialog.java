...
public class AppSelectDialog implements AppsLoadListener {
    ...
    public AppSelectDialog(Activity activity, int title_res, AppSelectListener listener) {
        mActivity = activity;
    ...
    private Dialog getDialog() {
        ...
        AlertDialog.Builder builder = new android.app.AlertDialog.Builder(mActivity);
        ...
        apps.setSelectedAppListener(new AppsListView.OnSelectedAppListener() {

...
public class EmptyRecyclerView extends ListView {
     ...
     */
    public static class MyLinearLayoutManager extends LinearLayout {
    ...
    private void init() {
        ...
        setOnApplyWindowInsetsListener(new OnApplyWindowInsetsListener(){
                ...
                public WindowInsets onApplyWindowInsets(View v, WindowInsets windowInsets) {
                    ...
                    boolean isImeOpen = windowInsets.getInsets(WindowInsets.Type.ime()).bottom > 0;
